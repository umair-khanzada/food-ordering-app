...
import { SELECT, TEXT_FIELD } from '../../../../components/AddEditForm/FieldTypes';
...
const EditVendor = () => {
  ...
  return <AddEditForm buttons={buttons} fields={fields} heading="Edit Vendor" onSaveSuccess={onSaveSuccess} />;
};
